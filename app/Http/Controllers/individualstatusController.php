...
use App\individualstatusModel;

class individualstatusController extends Controller
{
    private function validate_input($input)
    {
        // sert the required fields
        $required_fields = array('status_name','description','active');
    ...
    public function store(Request $request)
    {
        ...
        // create the new role using the supplied parameters
        try {
          $individual_status = new individualstatusModel;
          $individual_status->status_name=$request->status_name;
          $individual_status->description=$request->description;
          $individual_status->notes=$request->notes;
          $individual_status->active=$active;
          $individual_status->save();
          //$inserted_id = $individual_status->individual_status_id;
          return response()->json(['status'=>'success','data'=>[$individual_status]],200);
    ...
    {
        // return the individual status details by id
        try {
    ...
    public function update(Request $request, $id)
    {
        ...
        // create the new role using the supplied parameters
        try {
          $individual_status = individualstatusModel::find($id);
          $individual_status->status_name=$request->status_name;
          $individual_status->description=$request->description;
          $individual_status->notes=$request->notes;
          $individual_status->active=$active;
